...
La infraestructura del dashboard también está definida con Terraform dentro de \texttt{infra/observability}. Se crea un repositorio ECR para la imagen de monitoreo, un bucket S3 de observabilidad, un cluster/servicio ECS Fargate para Streamlit, un security group que expone el puerto \texttt{8501} y un log group de CloudWatch con retención de 7 días.
